...
public:
	...
	virtual void Render(ID3D12GraphicsCommandList* commandList, UINT nInstances);
	virtual void Render(ID3D12GraphicsCommandList* commandList, UINT nInstances, D3D12_VERTEX_BUFFER_VIEW instancingBufferView);
protected:
