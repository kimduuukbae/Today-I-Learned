...
bool CGameObject::IsVisible(CCamera* pCamera){
	...
	BoundingOrientedBox boundBox{ mesh->GetBoundingBox() };
	boundBox.Transform(boundBox, XMLoadFloat4x4(&worldMatrix));
	if (pCamera) bIsVisible = pCamera->IsInFrustum(boundBox);
	return bIsVisible;
}
